  ...
  <div class="ui two column middle aligned center aligned grid container">
    <div class="column">
      <h2 class="ui teal image header">
        ...
        <div class="content">
          Sign-up for user account<br><?php echo "$msg"; ?>
        </div>
      </h2>
      <form class="ui large form error" action="usignup_proc.php" method="post">
      ...
      <div class="ui message">
        <h4>Existing user ? <a href="ulogin.php">Login</a></h4>
      </div>
    </div>
  </div>
